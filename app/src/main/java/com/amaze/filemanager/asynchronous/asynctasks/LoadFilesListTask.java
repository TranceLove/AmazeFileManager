...
public class LoadFilesListTask
  ...
  private @NonNull ArrayList<LayoutElementParcelable> listMediaCommon(@NonNull String[] projection, @Nullable String selection) {
    Cursor cursor =
            context
                    .getContentResolver()
  ...
  private void listRemovables(String path, OnFileFound fileFound) {
    OTGUtil.getDocumentFilesSaf(path, context, fileFound);
  }

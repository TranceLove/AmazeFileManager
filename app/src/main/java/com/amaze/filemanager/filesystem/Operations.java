...
public class Operations {
  ...
  public static void mkdir(
    ...
    new AsyncTask<Void, Void, Void>() {
      ...
      private Function<Pair<DocumentFile, DocumentFile>, Void> safCreateDirectory = input -> {
      ...
      protected Void doInBackground(Void... params) {
        ...
        if (file.isSmb()) {
          ...
          safCreateDirectory.apply(new Pair<>(OTGUtil.getDocumentFile(file.getPath(), context, false),
            OTGUtil.getDocumentFile(file.getParent(context), context, false)));
          return null;
        } else if (file.isDocumentFile()) {
          safCreateDirectory.apply(new Pair<>(OTGUtil.getDocumentFile(file.getPath(), SafRootHolder.INSTANCE.getUriRoot(), context, false),
            OTGUtil.getDocumentFile(file.getParent(context), SafRootHolder.INSTANCE.getUriRoot(), context, false)));
          return null;
  ...
  public static void mkfile(
    ...
    new AsyncTask<Void, Void, Void>() {
      ...
      private Function<Pair<DocumentFile, DocumentFile>, Void> safCreateFile = input -> {
      ...
      protected Void doInBackground(Void... params) {
        ...
        if (file.isSmb()) {
          ...
          safCreateFile.apply(new Pair<>(OTGUtil.getDocumentFile(file.getPath(), context, false),
            OTGUtil.getDocumentFile(file.getParent(context), context, false)));
          return null;
        } else if (file.isDocumentFile()) {
          safCreateFile.apply(new Pair<>(OTGUtil.getDocumentFile(file.getPath(), SafRootHolder.INSTANCE.getUriRoot(), context, false),
            OTGUtil.getDocumentFile(file.getParent(context), SafRootHolder.INSTANCE.getUriRoot(), context, false)));
          return null;
        } else {
          if (file.isLocal() || file.isRoot()) {
  ...
  public static void rename(
    ...
    new AsyncTask<Void, Void, Void>() {
      ...
      private Function<Pair<DocumentFile, DocumentFile>, Void> safRenameFile = input -> {
      ...
      protected Void doInBackground(Void... params) {
        ...
        if (oldFile.isSmb()) {
          ...
          safRenameFile.apply(new Pair<>(OTGUtil.getDocumentFile(oldFile.getPath(), context, false),
            OTGUtil.getDocumentFile(newFile.getPath(), context, false)));
          return null;
        } else if (oldFile.isDocumentFile()) {
          safRenameFile.apply(new Pair<>(OTGUtil.getDocumentFile(oldFile.getPath(), SafRootHolder.INSTANCE.getUriRoot(), context, false),
            OTGUtil.getDocumentFile(newFile.getPath(), SafRootHolder.INSTANCE.getUriRoot(), context, false)));
          return null;
        } else {

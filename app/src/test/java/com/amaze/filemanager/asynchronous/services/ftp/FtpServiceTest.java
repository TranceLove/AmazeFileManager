...
import static com.amaze.filemanager.asynchronous.services.ftp.FtpService.KEY_PREFERENCE_SECURE;
...
import com.amaze.filemanager.shadows.ShadowContentResolverWithLocalOutputStreamSupport;
...
public class FtpServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    ShadowConnectivityManager cm =
        Shadows.shadowOf(
            (ConnectivityManager)
                RuntimeEnvironment.application.getSystemService(CONNECTIVITY_SERVICE));
    ShadowWifiManager wifiManager =
        Shadows.shadowOf(
            (WifiManager) RuntimeEnvironment.application.getSystemService(WIFI_SERVICE));
    ...
    ReflectionHelpers.callInstanceMethod(
        ...
        "setInetAddress",
        ReflectionHelpers.ClassParameter.from(InetAddress.class, InetAddress.getLoopbackAddress()));
    ...
    prefs
        ...
        .putInt(KEY_PREFERENCE_PORT, FTP_PORT)
        .commit();
  ...
  public void testDownloadFile() throws IOException {
    ...
    ShadowContentResolverWithLocalOutputStreamSupport contentResolver =
        Shadow.extract(RuntimeEnvironment.application.getContentResolver());
    contentResolver.registerInputStream(
        Uri.fromFile(testFile1),
        new ByteArrayInputStream(randomString.getBytes(Charset.forName("UTF-8"))));
